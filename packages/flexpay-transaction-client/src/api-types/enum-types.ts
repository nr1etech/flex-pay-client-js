...
export const EngagedRecoverState = {
	State0: 0,
};
export type EngagedRecoverState = typeof EngagedRecoverState[keyof typeof EngagedRecoverState];


// The values are numeric, however, the value of the responseCode field is sent as a string. Therefore, these are defined as strings to avoid frequent conversion of the field or enum values
